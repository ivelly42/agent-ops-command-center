...
```bash
npm exec --yes --package=https://github.com/ivelly42/agent-ops-command-center/releases/download/v5.120-preview/agent-ops-command-center-0.5.120.tgz -- agent-ops-command-center --team-request-url
npm exec --yes --package=https://github.com/ivelly42/agent-ops-command-center/releases/download/v5.120-preview/agent-ops-command-center-0.5.120.tgz -- agent-ops-command-center --json
```

Tarball: https://github.com/ivelly42/agent-ops-command-center/releases/download/v5.120-preview/agent-ops-command-center-0.5.120.tgz
