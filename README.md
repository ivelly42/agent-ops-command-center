...
GitHub procurement mirror Pages: https://ivelly42.github.io/ai-agent-procurement-template/
...
Team invoice direct request: [team-invoice-request.html](team-invoice-request.html)
...
- [Team invoice direct request](team-invoice-request.html)
...
- [AI Agent Cost Leak Audit](ai-agent-cost-leak-audit.md)
...
- [AI Agent Done Checklist](ai-agent-done-checklist.md)
...
- [Codex vs Claude Code vs Cursor Workflow Picker](codex-vs-claude-code-vs-cursor.md)
...
- [AI Coding Agent Review Brief Template](review-brief-template.md)
...
- [AI Agent Handoff Template](ai-agent-handoff-template.md)
...
- [AI Agent PR Review Scorecard](ai-agent-pr-review-scorecard.md)
- [AI Agent Verification Command Library](ai-agent-verification-command-library.md)
- [Paid Delivery Manifest](paid-delivery-manifest.md)
- [Buyer Decision Matrix](buyer-decision-matrix.md)
...
- [sample/verification_ledger_sample.csv](sample/verification_ledger_sample.csv)
...
Revenue target: 7 sales = `$203` gross.
...
- Twenty-eight operating templates
- social launch copy
- outreach copy
