...
MCP command: `npm exec --yes --package=https://github.com/ivelly42/agent-ops-command-center/releases/download/v5.139-preview/agent-ops-command-center-0.5.139.tgz -- agent-ops-mcp-server`
...
Checkout live: false. Preferred path remains the $203 team-license request until a receipt-capable checkout exists.
# Agent Ops Command Center Preview Index
...
- NPM release tarball team request: `npm exec --yes --package=https://github.com/ivelly42/agent-ops-command-center/releases/download/v5.139-preview/agent-ops-command-center-0.5.139.tgz -- agent-ops-command-center --team-request-url`
...
- GitHub Pages rollout checklist mirror: https://ivelly42.github.io/ai-agent-rollout-checklist-template/
...
- GitHub Pages change approval mirror: https://ivelly42.github.io/ai-agent-change-approval-template/
...
- GitHub Pages receipt request mirror: https://ivelly42.github.io/ai-agent-receipt-request-template/
...
- GitHub Pages expense report mirror: https://ivelly42.github.io/ai-agent-expense-report-template/
...
- Weekly operator review template: https://ivelly42.github.io/agent-ops-command-center/weekly-operator-review-template.md
...
- Preview release: https://github.com/ivelly42/agent-ops-command-center/releases/tag/v5.139-preview
...
| Area | Purpose |
| --- | --- |
| Agent Registry | Choose the right agent and record model/tool fit |
...
| Model Routing Mirror | Route model-selection, model-routing, review-path, and cost-control searches into the $203 request path |
...
| Security Review Issue Form | Capture security-review-ready buyers as order-request issues for the $203 team request path |
...
| Budget Request Issue Form | Capture approved-budget buyers as order-request issues for the $203 team request path |
